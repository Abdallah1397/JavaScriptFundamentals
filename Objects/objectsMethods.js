...
console.log(Object.entries(obj)); // [ [ 'firstName', 'Abdallah' ], [ 'lastName', 'Mahmoud' ] ]
...
console.log(Object.getOwnPropertyNames(person)); // [ 'name', 'age', 'country', 'salary' ] 


// 4-hasOwn()
// static method returns true if the specified object has the indicated property as its own property.
// If the property is inherited, or does not exist, the method returns false.
console.log(Object.hasOwn(obj, "firstName")); //true
...
console.log(Object.values(person)); // [ 'gopal', '21', 'India' ]
